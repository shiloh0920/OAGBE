...
<FORM METHOD="post" ACTION="rest.do" enctype="multipart/form-data" name="form1">
	<div>
	<div class="rest_dish_select_qty">餐廳編號:<font color=red><b> * </b></font>${restVO.restid}</div>
...
<!--         <a class="btn btn-outline-secondary"  href="restcmsadd.jsp">新增</a> -->
		<a class="btn btn-outline-secondary" href="restcmslistall.jsp">餐廳管理</a>
      </div>
