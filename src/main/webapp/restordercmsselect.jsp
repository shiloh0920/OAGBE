...
<ul>
  ...
  <div class="h_center">
    <FORM METHOD="post" ACTION="restOrder.do" >
        <div class="mb-3">
                <div class="rest_dish_select_qty">輸入訂單編號:
                  <label for="InputOrderid" class="form-label">
                  <input type="text" class="form-control" name="orderid"  value="${param.orderid}" id="InputOrderid">
               </label>
               <font color=red>${errorMsgs.orderid}</font>
  ...
  <div class="h_center">
     ...
     <div class="mb-3">
       ...
       <select class="form-select" size="1" name="orderid" id="exampleSelect">
         <c:forEach var="restOrderVO" items="${restOrderSvc.all}" > 
          <option value="${restOrderVO.orderid}">${restOrderVO.orderid}
         </c:forEach>   
       </select></label>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" class="btn btn-primary" value="送出">
  ...
  <div class="h_center">
     <FORM METHOD="post" ACTION="restOrder.do" >
     	<div class="mb-3">
       <div class="rest_dish_select_qty">選擇會員編號:
       <label for="exampleSelect" class="form-label">
       <select class="form-select" size="1" name="orderid" id="exampleSelect">
         <c:forEach var="restOrderVO" items="${restOrderSvc.all}" > 
          <option value="${restOrderVO.orderid}">${restOrderVO.userid}
         </c:forEach>   
       </select></label>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" class="btn btn-primary" value="送出">
